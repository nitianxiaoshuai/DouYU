...
-(void)setZhanQiData:(ZhanqiModel *)zhanQiData
{
    
    [self.imageView sd_setImageWithURL:[NSURL URLWithString:zhanQiData.bpic]  placeholderImage:[UIImage imageNamed:@"Img_default.png"]];
    self.Name.text=zhanQiData.nickname;
    
    self.onlinePeople.text=[NSString stringWithFormat:@"%0.1f万",[zhanQiData.online doubleValue]/10000];
    self.Title.text=zhanQiData.title;
}
...
-(void)setHuoMaoData:(HoumaoData *)huoMaoData {
    [self.imageView sd_setImageWithURL:[NSURL URLWithString:huoMaoData.image] placeholderImage:[UIImage imageNamed:@"Img_default.png"]];
    self.Name.text=huoMaoData.username;
    
    self.onlinePeople.text=[NSString stringWithFormat:@"%0.1f万",[huoMaoData.views doubleValue]/10000];
    self.Title.text=huoMaoData.channel;
}
